    ...
    <div style="width: 50%;margin: 0 auto;">
        ...
        >
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="initDb">下一步</el-button>
            </div>
        </el-dialog>
...
<script>
    import configHis from "@/assets/his.json";
    ...
    export default {
        ...
        name: "InitDb",
        mounted: function () {
            this.history = JSON.parse(localStorage.getItem("history") || JSON.stringify(configHis));
