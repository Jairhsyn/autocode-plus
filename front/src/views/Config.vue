<template>
    <div style="width: 50%;margin: 0 auto;">
        <el-form label-position="right" label-width="120px" :model="config" size="mini">
            <el-form-item label="功能包code">
                <el-input v-model="code"
                          placeholder="举例:如果填teaching的话,则service和dao相关代码生成在com.ke.huaqiao.server.teaching下面"></el-input>
            </el-form-item>
    ...
    export default {
        ...
        methods: {
            commitSysConfig: function () {
                this.config = {
                    servicePackage: 'com.ke.huaqiao.server.service.' + this.code,
                    daoPackage: 'com.ke.huaqiao.server.service.' + this.code,
                }
